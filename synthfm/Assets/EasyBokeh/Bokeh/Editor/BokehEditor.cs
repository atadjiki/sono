...
using UnityEditor;
    ...
    [CanEditMultipleObjects, CustomEditor(typeof(EasyBokeh))]
	...
	SerializedProperty _lightIntensity;
	...
	static GUIContent _labelShape = new GUIContent(
		"Shape Of Bokeh",
		"The larger value is less blur content"
	);
	static GUIContent _labelLightIntensity = new GUIContent(
		"Absorbation",
		""
	);
		...
		EditorGUILayout.PropertyField (_shape, _labelShape);
		EditorGUILayout.PropertyField (_lightIntensity, _labelLightIntensity);
